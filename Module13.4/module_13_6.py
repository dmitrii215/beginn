...
kb2.add(in_button1)
in_button2 = InlineKeyboardButton(text='Формула рассчета', callback_data='formulas')
kb2.add(in_button2)
...
async  def inform(message):
    await  message.answer('Расчёт необходимого количества килокалорий (ккал) '
                         'в сутки для каждого конкретного человека. По формулуe Миффлина-Сан Жеора'
